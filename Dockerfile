...
RUN dpkg --add-architecture i386 && \
        ...
        wget https://download.opensuse.org/repositories/Emulators:/Wine:/Debian/Debian_10/amd64/libfaudio0_20.01-0~buster_amd64.deb && apt-get install ./libfaudio0_20.01-0~buster_amd64.deb -y && \
        wget https://download.opensuse.org/repositories/Emulators:/Wine:/Debian/Debian_10/i386/libfaudio0_20.01-0~buster_i386.deb && apt-get install ./libfaudio0_20.01-0~buster_i386.deb -y && \
